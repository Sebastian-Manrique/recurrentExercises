...
public class Sudoku implements ActionListener{
	...
	public Sudoku() {
	    ...
	    panel.setLayout(new GridLayout(4, 4, 2, 2)); // 4 rows, 6 columns, with 2 pixels space
		
		for (int i=0; i<6;i++) { //Row
			for (int j = 0; j < 4; j++) { //Column	
				JTextField t=new JTextField("i "+i+" j "+j); //Create a window using JFrame with nothing (  )
...
//			JOptionPane.showInternalMessageDialog(null, "fin");		
			System.exit(0);
		}
	}
